...
The speed and character of TOD means that even when well-intentioned and well-planned, it often resembles a parasitic or at least commensalistic growth on its host neighborhoods. And because of the sheer number of shiny new units that it brings, TOD can easily raise the average price of an apartment in a neighborhood. Depending on what geographic scale you're considering, you can tell one of two very different stories about the impact that it is going to have.

### The local story: development as a harbinger of gentrification
The story we understand about how gentrification happens has birthed a thousand SF open-mic jokes, and has a classic cast of characters: the yuppie artist types looking for cheap rent somewhere "real", the proprietors of goat yoga studios and driftwood-themed coffee shops eager to get a foothold in a trendy neighborhood, the food critic gingerly dispatched by the local paper to report that the neighborhood is now safe for white people, the developers ready bulldoze a quiet family neighborhood to sell a thousand luxury apartments, and the corrupt local alderman taking kickbacks to rubber-stamp the whole thing. This is a model in which the cost of living is driven upwards by perceived "desirability" of the neighborhood, and nothing makes a neighborhood more desirable to young professionals looking to experience urban life at its fullest than a genuine, bona-fide, electrified, three-car light rail line serving their neighborhood.

But the people who can actually afford to live near the train are, paradoxically, the ones least likely to make full use of it.


 it puts the cart before the horse (or, uh, the pedicab before the white guy with dreads).

### The regional story: development as a relief valve for a housing shortage
In American cities like San Francisco, Boston, Seattle, and Los Angeles, the massive affordability crisis is caused by the lack of housing altogether (especially housing near transit), not the apparition of new, more upscale housing units and businesses on the wanton whims of developers and the city council. These places are adding jobs much faster than they’re adding units of housing, which means that there’s mathematically no way for everyone who works in the city to live in the city. The deficit of new housing means that we need a lot of new units, as soon as possible. Because the market has inflated the value of a home to an unreasonable level, these "market rate" units will still be expensive, and it will some years for the market to take them into account and for them to "filter" into affordability for lower income brackets, but eventually having housing stock commensurate with the number of jobs in the city will stabilize housing prices and permit more people to live in the city.
...
At the same time, deploying transit in a way that is predictably going to drive people out of their homes seems to more than defeat its purpose. We want everyone to want to use transit, but we should also recognize that the marginal utility of living near a rapid transit station for someone who is going to use it every day is greater than for someone who views it as an amenity that will help them beat traffic twice a year on their way to the Big Game. There is a whole story to tell here that I watch and participate in every day in SF — about white flight, about interstates and urban renewal, about the young and privileged returning to the city to treat it as their playground. For now I’ll skip to what I see as the punchline: that without understanding and managing the interaction between transit and displacement, we run the risk of replicating in our cities the problems that plague transit in the suburbs: low ridership causing funding cuts causing low ridership in a death spiral that limits everyone’s mobility, but disproportionately so the working class.
